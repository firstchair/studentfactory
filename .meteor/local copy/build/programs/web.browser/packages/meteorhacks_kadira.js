...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                  //
// packages/meteorhacks:kadira/lib/client/utils.js                                                  //
//                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                    //
...
getErrorStack = function (zone, callback) {                                                         // 17
  ...
  function processZone() {                                                                          // 28
    ...
    if(zone && zone.depth > 2) {                                                                    // 31
      ...
      var ownerArgsEvent = events && events[0] && events[0].type == 'owner-args' && events.shift(); // 39
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                  //
// packages/meteorhacks:kadira/lib/client/models/error.js                                           //
//                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                    //
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                  //
// packages/meteorhacks:kadira/lib/client/error_reporters/zone.js                                   //
//                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                    //
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                  //
// packages/meteorhacks:kadira/lib/client/error_reporters/window_error.js                           //
//                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                    //
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                  //
// packages/meteorhacks:kadira/lib/client/error_reporters/meteor_debug.js                           //
//                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                    //
var originalMeteorDebug = Meteor._debug;                                                            // 1
                                                                                                    // 2
Meteor._debug = function(message, stack) {                                                          // 3
  // track only if error tracking is enabled                                                        // 4
  if(!Kadira.options.enableErrorTracking) {                                                         // 5
    return originalMeteorDebug(message, stack);                                                     // 6
  }                                                                                                 // 7
                                                                                                    // 8
  // do not track if a zone is available (let zone handle the error)                                // 9
  if(window.zone) {                                                                                 // 10
    return originalMeteorDebug(message, stack);                                                     // 11
  }                                                                                                 // 12
                                                                                                    // 13
  // We hate Meteor._debug (no single usage pattern)                                                // 14
  if(message instanceof Error) {                                                                    // 15
    stack = message.stack;                                                                          // 16
    message = message.message                                                                       // 17
  } else if(typeof message == 'string' && stack === undefined) {                                    // 18
    stack = getStackFromMessage(message);                                                           // 19
    message = firstLine(message);                                                                   // 20
  }                                                                                                 // 21
                                                                                                    // 22
  // sometimes Meteor._debug is called with the stack concat to the message                         // 23
  // FIXME Meteor._debug can be called in many ways                                                 // 24
  if(message && stack === undefined) {                                                              // 25
    stack = getStackFromMessage(message);                                                           // 26
    message = firstLine(message);                                                                   // 27
  }                                                                                                 // 28
                                                                                                    // 29
  var now = (new Date().getTime());                                                                 // 30
  Kadira.errors.sendError({                                                                         // 31
    appId : Kadira.options.appId,                                                                   // 32
    name : message,                                                                                 // 33
    type : 'client',                                                                                // 34
    startTime : now,                                                                                // 35
    subType : 'meteor._debug',                                                                      // 36
    info : getBrowserInfo(),                                                                        // 37
    stacks : JSON.stringify([{at: now, events: [], stack: stack}]),                                 // 38
  });                                                                                               // 39
                                                                                                    // 40
  return originalMeteorDebug.apply(this, arguments);                                                // 41
};                                                                                                  // 42
                                                                                                    // 43
var stackRegex = /^\s+at\s.+$/gm;                                                                   // 44
function getStackFromMessage (message) {                                                            // 45
  // add empty string to add the empty line at start                                                // 46
  var stack = [''];                                                                                 // 47
  var match;                                                                                        // 48
  while(match = stackRegex.exec(message)) {                                                         // 49
    stack.push(match[0]);                                                                           // 50
  }                                                                                                 // 51
  return stack.join('\n');                                                                          // 52
}                                                                                                   // 53
                                                                                                    // 54
function firstLine (message) {                                                                      // 55
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                  //
// packages/meteorhacks:kadira/lib/client/kadira.js                                                 //
//                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                    //
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                  //
// packages/meteorhacks:kadira/lib/profiler/client.js                                               //
//                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                    //
