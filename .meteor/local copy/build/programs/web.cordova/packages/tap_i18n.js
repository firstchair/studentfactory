...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/tap:i18n/lib/tap_i18n/tap_i18n-client.coffee.js                                                           //
// This file is in bare mode and is not in its own closure.                                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
__coffeescriptShare = typeof __coffeescriptShare === 'object' ? __coffeescriptShare : {}; var share = __coffeescriptShare;
var loaded_lang_session_key,
...
_.extend(TAPi18n, {
  ...
  _loadLanguage: function(languageTag) {
    var dependencyLoadDfd, dfd, directDependencyLanguageTag, loadLanguageTag, project_languages, self;
    self = this;
    dfd = new $.Deferred();
    if (!this._enabled()) {
    ...
    if (__indexOf.call(project_languages, languageTag) >= 0) {
      if (__indexOf.call(self._loaded_languages, languageTag) < 0) {
        ...
        directDependencyLanguageTag = __indexOf.call(languageTag, "-") >= 0 ? languageTag.replace(/-.*/, "") : fallback_language;
        if (languageTag !== fallback_language && __indexOf.call(project_languages, directDependencyLanguageTag) >= 0) {
  ...
  _registerHelpers: function(package_name, template) {
    var helpers, self, tapI18nextProxy, underscore_helper;
    self = this;
    if (package_name !== globals.project_translations_domain) {
      tapI18nextProxy = this._getPackageI18nextProxy(self.packages[package_name].namespace);
    } else {
    ...
    if (package_name !== globals.project_translations_domain) {
      ...
      return UI.registerHelper("languageTag", function() {
  ...
  _getRegisterHelpersProxy: function(package_name) {
    ...
    return function(template) {
      return self._registerHelpers(package_name, template);
    };
  },
  ...
  _onceEnabled: function() {
    return TAPi18n._registerHelpers(globals.project_translations_domain);
  },
  setLanguage: function(lang_tag) {
    ...
    return this._loadLanguage(lang_tag).then(function() {
      ...
      return Session.set(loaded_lang_session_key, lang_tag);
    });
  },
