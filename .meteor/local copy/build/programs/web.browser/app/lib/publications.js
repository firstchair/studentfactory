(function(){privacyOptions = { // true means exposed
  _id: true,
  commentCount: true,
  createdAt: true,
  email_hash: true,
  ...
  'profile.bio': true,
  'profile.github': true,
  'profile.dribbble': true,
  'profile.behance': true,
  'profile.site': true,
  ...
  'services.dribbble.screenName': true,
  'services.behance.screenName': true,
...
avatarOptions = {
  ...
  // 'services.linkedin.profile_image_url': true,
  'services.twitter.profile_image_url_https': true,
  'services.twitter.profile_image_url': true,
  'services.twitter.profile_image_url_https': true,
  'services.facebook.id': true,
