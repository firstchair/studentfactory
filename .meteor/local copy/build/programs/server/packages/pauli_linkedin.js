...
///////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                           //
// packages/pauli:linkedin/linkedin_server.js                                                //
//                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////
                                                                                             //
var OAuth = Package.oauth.OAuth;                                                             // 1
                                                                                             // 2
var urlUtil = Npm.require('url');                                                            // 3
                                                                                             // 4
OAuth.registerService('linkedin', 2, null, function(query) {                                 // 5
                                                                                             // 6
  var response = getTokenResponse(query);                                                    // 7
  var accessToken = response.accessToken;                                                    // 8
  var identity = getIdentity(accessToken);                                                   // 9
  var profileUrl = identity.siteStandardProfileRequest.url;                                  // 10
  var urlParts = urlUtil.parse(profileUrl, true);                                            // 11
                                                                                             // 12
  var serviceData = {                                                                        // 13
    id: urlParts.query.id || Random.id(),                                                    // 14
